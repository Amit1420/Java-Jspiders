...
public abstract class TestSorted2 {
	...
	public static void main(String[] args) {
		...
		List<Customer> sortedByName = d.sortedByName(l);
		sortedByName.forEach(e -> System.out.println(e));
		System.out.println("*********************Sorted By Product******************");
		List<Customer> sortedByProduct = d.sortedByProduct(l);
		sortedByProduct.forEach(e -> System.out.println(e));
	}
