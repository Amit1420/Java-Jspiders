...
public class OptionalImp2 {
	
	public static void main(String[] args) {
	Customer dataById = getDataById(20);
	...
	public static Customer getDataById(int id)
	{
		...
		Customer any= l.stream().distinct().filter(e->e.getId()==id)
				.findFirst().orElse(new Customer(1, "Amit", "Potato", "Vegetables"));
		return any;
